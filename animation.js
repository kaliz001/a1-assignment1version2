function swap_language_image() {
    ...
    if (current_image == "https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" ) {
      document.getElementById("Image_To_Switch").src =
      "https://cdn.iconscout.com/icon/free/png-256/css-131-722685.png";
    } else if (current_image == "https://cdn.iconscout.com/icon/free/png-256/css-131-722685.png") {
      document.getElementById("Image_To_Switch").src =
